  ...
  async runTransaction(e, t, n, r) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        const t2 = __PRIVATE_SimpleDbTransaction.open(this.db, e, i ? "readonly" : "readwrite", n), s2 = r(t2).next((e2) => (t2.S(), e2)).catch((e2) => (t2.abort(e2), PersistencePromise.reject(e2))).toPromise();
        return s2.catch(() => {
        }), await t2.p, s2;
      } catch (e2) {
...
var __PRIVATE_QueryImpl = class {
  constructor(e, t = null, n = [], r = [], i = null, s = "F", o = null, _ = null) {
    this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.he = null, this.Pe = null, this.Te = null, this.startAt, this.endAt;
  }
};
...
function __PRIVATE_queryToAggregateTarget(e) {
  const t = __PRIVATE_debugCast(e);
  return t.Te || (t.Te = __PRIVATE__queryToTarget(t, e.explicitOrderBy)), t.Te;
}
...
var BloomFilter = class {
  constructor(e, t, n) {
    ...
    this.Ee = 8 * e.length - t, this.de = Integer.fromNumber(this.Ee);
  }
  Ae(e, t, n) {
...
var __PRIVATE_TargetState = class {
  constructor() {
    this.pe = 0, this.ye = __PRIVATE_snapshotChangesMap(), this.we = ByteString.EMPTY_BYTE_STRING, this.Se = false, this.be = true;
  }
  get current() {
    return this.Se;
  }
...
var __PRIVATE_WatchChangeAggregator = class {
  constructor(e) {
    this.ke = e, this.qe = /* @__PURE__ */ new Map(), this.Qe = __PRIVATE_mutableDocumentMap(), this.$e = __PRIVATE_documentTargetMap(), this.Ue = __PRIVATE_documentTargetMap(), this.Ke = new SortedMap(__PRIVATE_primitiveComparator);
  }
  We(e) {
    for (const t of e.me)
    ...
    this.forEachTarget(e, (t) => {
      ...
      switch (e.state) {
        case 0:
          ...
          break;
        case 1:
          n.Be(), n.De || n.Me(), n.Ce(e.resumeToken);
          break;
        case 2:
        ...
        case 3:
          ...
          break;
        case 4:
          this.Je(t) && (this.Ye(t), n.Ce(e.resumeToken));
          break;
        default:
          fail();
      }
  ...
  st(e, t) {
    ...
    return n.forEach((n2) => {
      ...
      e.mightContain(s) || (this.ze(t, n2, null), r++);
    }), r;
  }
  ot(e) {
    const t = /* @__PURE__ */ new Map();
  ...
  ze(e, t, n) {
    if (!this.Je(e))
      return;
    const r = this.He(e);
    this.ut(e, t) ? r.xe(t, 1) : r.Oe(t), this.Ue = this.Ue.insert(t, this.ct(t).delete(e)), this.Ue = this.Ue.insert(t, this.ct(t).add(e)), n && (this.Qe = this.Qe.insert(t, n));
  }
  removeTarget(e) {
    this.qe.delete(e);
  }
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Rt(e, t) {
    if ("nullValue" in e)
      ...
      isNaN(n) ? this.ft(t, 13) : (this.ft(t, 15), __PRIVATE_isNegativeZero(n) ? t.gt(0) : t.gt(n));
  ...
  vt(e, t) {
    ...
    this.ft(t, 15), t.gt(__PRIVATE_normalizeNumber(o)), this.wt(s, t), this.Rt(i[s], t);
  }
  Ft(e, t) {
    const n = e.values || [];
    this.ft(t, 50);
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
    this.databaseId = t, this.In = new __PRIVATE_MemoryCollectionParentIndex(), this.En = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  addToCollectionParentIndex(e, t) {
    if (!this.In.has(t)) {
  ...
  fn(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.xt.At(e, t.tn(0)), t.Yt();
  }
  wn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
...
var __PRIVATE_IndexedDbMutationQueue = class {
  constructor(e, t, n, r) {
    this.userId = e, this.serializer = t, this.indexManager = n, this.referenceDelegate = r, this.Bn = {};
  }
  static It(e, t, n, r) {
...
var __PRIVATE_IndexedDbLruDelegateImpl = class {
  ...
  _r(e, t) {
    ...
    return n.Z({
      ...
      0 === e2 ? (i !== __PRIVATE_ListenSequence.ae && t(new DocumentKey(__PRIVATE_decodeResourcePath(r)), i), i = o, r = s) : i = __PRIVATE_ListenSequence.ae;
    }).next(() => {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  hr(e, t, n) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).Z({
      ...
      o && o.isEqual(i2) && (n(o, t2), o = s.hasNext() ? s.getNext() : null), o ? r2.W(__PRIVATE_dbKey(o)) : r2.done();
    }).next(() => {
      for (; o; )
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  constructor(e, t) {
    super(), this.Ir = e, this.trackRemovals = t, this.Er = new ObjectMap((e2) => e2.toString(), (e2, t2) => e2.isEqual(t2));
  }
  applyChanges(e) {
    const t = [];
  ...
  getAllFromCache(e, t) {
    return this.Ir.Pr(e, t).next(({ documents: e2, Tr: t2 }) => (t2.forEach((t3, n) => {
      this.Er.set(t3, {
        size: n,
...
var __PRIVATE_ReferenceSet = class {
  constructor() {
    this.Vr = new SortedSet(__PRIVATE_DocReference.mr), this.gr = new SortedSet(__PRIVATE_DocReference.pr);
  }
  isEmpty() {
...
var __PRIVATE_MemoryMutationQueue = class {
  constructor(e, t) {
    this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.Fr = 1, this.Mr = new SortedSet(__PRIVATE_DocReference.mr);
  }
  checkEmpty(e) {
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    return this.Mr.forEachWhile((e2) => {
      ...
      return !!n.isPrefixOf(t2) && (t2.length === r && (o = o.add(e2.Cr)), true);
...
var __PRIVATE_MemoryRemoteDocumentCacheImpl = class {
  constructor(e) {
    this.kr = e, this.docs = function __PRIVATE_documentEntryMap() {
      return new SortedMap(DocumentKey.comparator);
    }(), this.size = 0;
  }
  setIndexManager(e) {
...
var __PRIVATE_MemoryTargetCache = class {
  constructor(e) {
    this.persistence = e, this.Qr = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.$r = 0, this.Ur = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.Kr = __PRIVATE_TargetIdGenerator.Un();
  }
  forEachTarget(e, t) {
...
var __PRIVATE_MemoryEagerDelegate = class {
  constructor(e) {
    this.persistence = e, this.ti = new __PRIVATE_ReferenceSet(), this.ni = null;
  }
  static ri(e) {
...
var __PRIVATE_IndexedDbPersistence = class {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Ti = i, this.window = s, this.document = o, this.Ii = a, this.Ei = u, this.di = c, this.Gr = null, this.zr = false, this.isPrimary = false, this.networkEnabled = true, this.Ai = null, this.inForeground = false, this.Ri = null, this.Vi = null, this.mi = Number.NEGATIVE_INFINITY, this.fi = (e2) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.D())
  ...
  setNetworkEnabled(e) {
    this.networkEnabled !== e && (this.networkEnabled = e, this.Ti.enqueueAndForget(async () => {
  ...
  wi() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (!this.allowTabSynchronization)
        throw e;
      return __PRIVATE_logDebug(vt, "Releasing owner lease after error during lease refresh", e), false;
    }).then((e) => {
  ...
  async shutdown() {
    this.zr = false, this.Ui(), this.Vi && (this.Vi.cancel(), this.Vi = null), this.Ki(), this.Wi(), await this.pi.runTransaction("shutdown", "readwrite", [K, Re], (e) => {
      const t = new __PRIVATE_IndexedDbTransaction(e, __PRIVATE_ListenSequence.ae);
      return this.xi(t).next(() => this.Bi(t));
    }), this.pi.close(), this.Gi();
  }
  qi(e, t) {
  ...
  bi() {
    ...
    "function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) && (this.Ai = () => {
      ...
      isSafari() && (navigator.appVersion.match(e2) || navigator.userAgent.match(e2)) && this.Ti.enterRestrictedMode(true), this.Ti.enqueueAndForget(() => this.shutdown());
...
var __PRIVATE_QueryEngine = class {
  constructor() {
    this.Zi = false, this.Xi = false, this.es = 100, this.ts = function __PRIVATE_getDefaultRelativeIndexReadCostPerDocument() {
  ...
  rs(e, t) {
    ...
    return this.indexManager.getIndexType(e, n).next((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next((r2) => {
      ...
      return this.ns.getDocuments(e, i).next((r3) => this.indexManager.getMinOffset(e, n).next((n2) => {
        ...
        return this.ls(t, s, i, n2.readTime) ? this.rs(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.hs(e, s, t, n2);
      }));
    })));
  }
  ss(e, t, n, r) {
  ...
  hs(e, t, n, r) {
    return this.ns.getDocumentsMatchingQuery(e, n, r).next((e2) => (t.forEach((t2) => {
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r) {
    this.persistence = e, this.Ps = t, this.serializer = r, this.Ts = new SortedMap(__PRIVATE_primitiveComparator), this.Is = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.Es = /* @__PURE__ */ new Map(), this.ds = e.getRemoteDocumentCache(), this.Hr = e.getTargetCache(), this.Yr = e.getBundleCache(), this.As(n);
  }
  As(e) {
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (e2) => {
    let r;
    return n.Hr.getTargetData(e2, t).next((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.Hr.allocateTargetId(e2).next((i2) => (r = new TargetData(t, i2, "TargetPurposeListen", e2.currentSequenceNumber), n.Hr.addTargetData(e2, r).next(() => r))));
  }).then((e2) => {
...
var __PRIVATE_SharedOnlineState = class {
  ...
  static Ss(e) {
    ...
    return "object" == typeof t && -1 !== ["Unknown", "Online", "Offline"].indexOf(t.onlineState) && "string" == typeof t.clientId ? new __PRIVATE_SharedOnlineState(t.clientId, t.onlineState) : (__PRIVATE_logError(qt, `Failed to parse online state: ${e}`), null);
  }
};
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.Ti = t, this.persistenceKey = n, this.Cs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Fs = this.Ms.bind(this), this.xs = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, this.Os = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Ns = createWebStorageClientStateKey(this.persistenceKey, this.Cs), this.Bs = function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.xs = this.xs.insert(this.Cs, new __PRIVATE_LocalClientState()), this.Ls = new RegExp(`^${Bt}_${s}_([^_]*)$`), this.ks = new RegExp(`^${Lt}_${s}_(\\d+)(?:_(.*))?$`), this.qs = new RegExp(`^${kt}_${s}_(\\d+)$`), this.Qs = function createWebStorageOnlineStateKey(e2) {
...
var __PRIVATE_WebChannelConnection = class extends __PRIVATE_RestConnection {
  ...
  Wo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.useFetchStreams = true), this.Do(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = C.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P.Uo(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r = 1.5, i = 6e4) {
    this.Ti = e, this.timerId = t, this.Go = n, this.zo = r, this.jo = i, this.Ho = 0, this.Jo = null, this.Yo = Date.now(), this.reset();
  }
  reset() {
    this.Ho = 0;
  }
  ...
  Xo(e) {
    ...
    r > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.Ho} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Jo = this.Ti.enqueueAfterDelay(this.timerId, r, () => (this.Yo = Date.now(), e())), this.Ho *= this.zo, this.Ho < this.Go && (this.Ho = this.Go), this.Ho > this.jo && (this.Ho = this.jo);
  }
  t_() {
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r, i, s, o, _) {
    this.Ti = e, this.n_ = n, this.r_ = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.i_ = 0, this.s_ = null, this.o_ = null, this.stream = null, this.__ = 0, this.a_ = new __PRIVATE_ExponentialBackoff(e, t);
  }
  u_() {
...
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  ...
  g_(e) {
    return __PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length), this.listener.D_();
  }
  onNext(e) {
    __PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, this.a_.reset();
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  B_() {
    0 === this.x_ && (this.L_("Unknown"), this.O_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.O_ = null, this.k_("Backend didn't respond within 10 seconds."), this.L_("Offline"), Promise.resolve())));
  }
  q_(e) {
    "Online" === this.state ? this.L_("Unknown") : (this.x_++, this.x_ >= 1 && (this.Q_(), this.k_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.L_("Offline")));
  }
  set(e) {
    this.Q_(), this.x_ = 0, "Online" === e && (this.N_ = false), this.L_(e);
  }
  L_(e) {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.U_ = [], this.K_ = /* @__PURE__ */ new Map(), this.W_ = /* @__PURE__ */ new Set(), this.G_ = [], this.z_ = i, this.z_.To((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(zt, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          t2.W_.add(4), await __PRIVATE_disableNetworkInternal(t2), t2.j_.set("Unknown"), t2.W_.delete(4), await __PRIVATE_enableNetworkInternal(t2);
        }(this));
      });
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.K_.has(t.targetId) || (n.K_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).c_() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r = __PRIVATE_ensureWatchStream(n);
  n.K_.delete(t), r.c_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.K_.size && (r.c_() ? r.P_() : __PRIVATE_canUseNetwork(n) && n.j_.set("Unknown"));
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.j_.q_(t), __PRIVATE_startWatchStream(e)) : e.j_.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  if (e.j_.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause)
    try {
    ...
    try {
      ...
      n.compareTo(t2) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        return n2.targetChanges.forEach((n3, r) => {
          ...
          if (!r)
            return;
          e2.K_.set(t4, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e2, t4);
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  if (!__PRIVATE_isIndexedDbTransactionError(t))
    throw t;
  e.W_.add(1), await __PRIVATE_disableNetworkInternal(e), e.j_.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug(zt, "Retrying IndexedDB access"), await n(), e.W_.delete(1), await __PRIVATE_enableNetworkInternal(e);
  });
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).S_ && await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      return __PRIVATE_isPermanentError(e3) && e3 !== C.ABORTED;
    }(t2.code)) {
      const n = e2.U_.shift();
      __PRIVATE_ensureWriteStream(e2).h_(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), await __PRIVATE_fillWritePipeline(e2);
    }
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.W_.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.j_.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.W_.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t ? (n.W_.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.W_.add(2), await __PRIVATE_disableNetworkInternal(n), n.j_.set("Unknown"));
}
function __PRIVATE_ensureWatchStream(e) {
  return e.J_ || (e.J_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.J_.h_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.j_.set("Unknown")) : (await e.J_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.J_;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.Y_ || (e.Y_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r = __PRIVATE_debugCast(e2);
    ...
    t ? (e.Y_.h_(), await __PRIVATE_fillWritePipeline(e)) : (await e.Y_.stop(), e.U_.length > 0 && (__PRIVATE_logDebug(zt, `Stopping write stream with ${e.U_.length} pending writes`), e.U_ = []));
  })), e.Y_;
}
...
var __PRIVATE_DocumentChangeSet = class {
  ...
  track(e) {
    ...
    n ? 0 !== e.type && 3 === n.type ? this.Z_ = this.Z_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.Z_ = this.Z_.insert(t, {
      type: n.type,
      doc: e.doc
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  s ? !s.na() && t.ra() && (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.ra() ? 0 : 1);
  try {
    switch (r) {
      case 0:
  ...
  if (n.queries.set(i, s), s.ta.push(t), t.sa(n.onlineState), s.ea) {
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
  ...
  if (s) {
    ...
    e2 >= 0 && (s.ta.splice(e2, 1), 0 === s.ta.length ? i = t.ra() ? 0 : 1 : !s.na() && t.ra() && (i = 2));
  }
  switch (i) {
    case 0:
...
var jt;
var Ht;
(Ht = jt || (jt = {}))._a = "default", Ht.Cache = "cache";
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.aa = t, this.ua = false, this.ca = null, this.onlineState = "Unknown", this.options = n || {};
  }
  oa(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.da = e, this.localStore = t, this.serializer = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
  }
  Aa(e) {
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.fa = t, this.ga = null, this.hasCachedResults = false, this.current = false, this.pa = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.ya = __PRIVATE_newQueryComparator(e), this.wa = new DocumentSet(this.ya);
  }
  get Sa() {
    return this.fa;
  }
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l !== h && (n.track({
          ...
          type: 2,
          doc: c
        }), P = true, (_ && this.ya(c, _) > 0 || a && this.ya(c, a) < 0) && (o = true));
      } else
        !u && c ? (n.track({
          type: 0,
          doc: c
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.La = {}, this.ka = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.qa = /* @__PURE__ */ new Map(), this.Qa = /* @__PURE__ */ new Set(), this.$a = new SortedMap(DocumentKey.comparator), this.Ua = /* @__PURE__ */ new Map(), this.Ka = new __PRIVATE_ReferenceSet(), this.Wa = {}, this.Ga = /* @__PURE__ */ new Map(), this.za = __PRIVATE_TargetIdGenerator.Kn(), this.onlineState = "Unknown", this.ja = void 0;
  }
  get isPrimaryClient() {
    return true === this.ja;
  }
...
async function __PRIVATE_syncEngineListen(e, t, n = true) {
  ...
  let i;
  const s = r.ka.get(t);
  return s ? (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.Na()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
    r,
    t,
    n,
    true
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.Ha = (t2, n2, r2) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
    ...
    i2.ls && (i2 = await __PRIVATE_localStoreExecuteQuery(
      e2.localStore,
      t3.query,
      false
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      const r = n.Ua.get(t2);
      r && (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r.Ba = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.Ba) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.Ba), r.Ba = false));
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    await __PRIVATE_syncEngineApplyRemoteEvent(r, i2), r.$a = r.$a.remove(s), r.Ua.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
  } else
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  if (e.qa.delete(t), e.isPrimaryClient) {
    e.Ka.br(t).forEach((t2) => {
      e.Ka.containsKey(t2) || __PRIVATE_removeLimboTarget(e, t2);
    });
  }
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      ...
      e.Ka.containsKey(r.key) || __PRIVATE_removeLimboTarget(e, r.key);
    } else
      fail();
}
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  ...
  if (!n.currentUser.isEqual(t)) {
    ...
    }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e2.removedBatchIds, e2.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.Rs);
  }
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  ...
  }(i.localStore, t)) : fail(), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, s)) : __PRIVATE_logDebug(Jt, "Cannot apply mutation batch with id: " + t);
}
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.ja) {
    ...
    for (const e2 of n)
      r.qa.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.ru.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.ru.syncEngine), await __PRIVATE_fillWritePipeline(this.ru.remoteStore), await this.persistence.Ci(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  eu(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(e, t, false), this.ru = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    }, await this.sharedClientState.start()), await this.persistence.Ci(async (e2) => {
...
var OnlineComponentProvider = class {
  ...
  async terminate() {
    ...
    await async function __PRIVATE_remoteStoreShutdown(e2) {
      ...
      __PRIVATE_logDebug(zt, "RemoteStore shutting down."), t2.W_.add(5), await __PRIVATE_disableNetworkInternal(t2), t2.z_.shutdown(), t2.j_.set("Unknown");
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.ou = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this._u = function __PRIVATE_newTextDecoder() {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.Tu = n.maxAttempts, this.a_ = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  Iu() {
    this.Tu -= 1, this.Eu();
  }
    ...
    if (e._uninitializedComponentsProvider) {
      ...
      try {
        ...
        if (!function __PRIVATE_canFallbackFromIndexedDbError(e2) {
          return "FirebaseError" === e2.name ? e2.code === C.FAILED_PRECONDITION || e2.code === C.UNIMPLEMENTED : !("undefined" != typeof DOMException && e2 instanceof DOMException) || 22 === e2.code || 20 === e2.code || 11 === e2.code;
        }(n))
          throw n;
...
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(false), async function __PRIVATE_remoteStoreDisableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      t2.W_.add(0), await __PRIVATE_disableNetworkInternal(t2), t2.j_.set("Offline");
    }(n);
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).ia.add(t2), t2.next();
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor(e = Promise.resolve()) {
    this.Vu = [], this.mu = false, this.fu = [], this.gu = null, this.pu = false, this.yu = false, this.wu = [], this.a_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.Su = () => {
...
var __PRIVATE_ParseContextImpl = class {
  constructor(e, t, n, r, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r, void 0 === i && this.Bu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S, b, e), registerVersion(S, b, "esm2017");
}();
export {
